...
object AppOpenAdHelper {
    ...
    fun loadAd(
        ...
        if (isNeedToShowAds && GuduAdsConfig.with(fContext).remoteConfigOpenAds && fContext.isOnline) {
    ...
    fun Activity.showAppOpenAd(
        ...
        if (!isThisAdShowing && isNeedToShowAds && GuduAdsConfig.with(this).remoteConfigOpenAds) {
