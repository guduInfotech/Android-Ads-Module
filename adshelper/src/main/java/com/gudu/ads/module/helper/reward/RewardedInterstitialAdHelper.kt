...
object RewardedInterstitialAdHelper {
    ...
    fun loadAd(
        ...
        if (isNeedToShow && GuduAdsConfig.with(fContext).remoteConfigInterstitialRewardAds && fContext.isOnline) {
    ...
    fun Activity.showRewardedInterstitialAd(
        ...
        if (isNeedToShow && GuduAdsConfig.with(this).remoteConfigInterstitialRewardAds) {
            if (!isThisAdShowing) {
