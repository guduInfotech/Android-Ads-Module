...
import com.gudu.ads.module.helper.admob_app_open_ad_model_list
import com.gudu.ads.module.helper.admob_rewarded_video_ad_model_list
...
import com.gudu.ads.module.helper.isOpenAdEnable
...
object RewardedVideoAdHelper {
    ...
    fun loadAd(
        ...
        if (isNeedToShow && GuduAdsConfig.with(fContext).remoteConfigRewardVideoAds && fContext.isOnline) {
    ...
    fun Activity.showRewardedVideoAd(
        ...
        if (isNeedToShow && GuduAdsConfig.with(this).remoteConfigRewardVideoAds) {
            if (!isThisAdShowing) {
