...
import com.gudu.ads.module.helper.NativeAdvancedModelHelper
import com.gudu.ads.module.helper.GuduAdsConfig
import com.gudu.ads.module.helper.activity.FullScreenNativeAdDialogActivity
import com.gudu.ads.module.helper.admob_interstitial_ad_model_list
import com.gudu.ads.module.helper.admob_rewarded_interstitial_ad_model_list
import com.gudu.ads.module.helper.isAnyAdOpen
import com.gudu.ads.module.helper.isAnyAdShowing
import com.gudu.ads.module.helper.isAppForeground
import com.gudu.ads.module.helper.isInterstitialAdShow
import com.gudu.ads.module.helper.isNeedToShowAds
import com.gudu.ads.module.helper.isOnline
import com.gudu.ads.module.helper.logE
import com.gudu.ads.module.helper.logI
import com.gudu.ads.module.helper.mList
import com.gudu.ads.module.helper.onDialogActivityDismiss
...
object InterstitialAdHelper {
    ...
    fun loadAd(
        ...
        if (isNeedToShow && GuduAdsConfig.with(fContext).remoteConfigInterstitialAds && fContext.isOnline) {
    ...
    fun Activity.showInterstitialAd(
        ...
        if (isNeedToShow && GuduAdsConfig.with(this).remoteConfigInterstitialAds) {
